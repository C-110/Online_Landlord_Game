...
QT_MOC_LITERAL(1, 10, 10), // "panelClose"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "GamePanel\0panelClose\0"
};
...
void GamePanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->panelClose(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GamePanel::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GamePanel::panelClose)) {
                *result = 0;
                return;
            }
        }
