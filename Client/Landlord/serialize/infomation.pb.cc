...
const ::_pbi::DescriptorTable descriptor_table_infomation_2eproto = {
    false, false, 440, descriptor_table_protodef_infomation_2eproto,
    "infomation.proto",
