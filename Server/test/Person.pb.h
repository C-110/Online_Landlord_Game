...
PROTOBUF_NAMESPACE_OPEN
template<> ::MyPerson::Person* Arena::CreateMaybeMessage<::MyPerson::Person>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace MyPerson {
...
class Person final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:MyPerson.Person) */ {
 public:
  ...
  public:
  void clear_addr();
  const ::MyAddress::Address& addr() const;
  PROTOBUF_NODISCARD ::MyAddress::Address* release_addr();
  ::MyAddress::Address* mutable_addr();
  void set_allocated_addr(::MyAddress::Address* addr);
  private:
  const ::MyAddress::Address& _internal_addr() const;
  ::MyAddress::Address* _internal_mutable_addr();
  public:
  void unsafe_arena_set_allocated_addr(
      ::MyAddress::Address* addr);
  ::MyAddress::Address* unsafe_arena_release_addr();
  ...
  // .MyPerson.Color color = 6;
  void clear_color();
  ::MyPerson::Color color() const;
  void set_color(::MyPerson::Color value);
  private:
  ::MyPerson::Color _internal_color() const;
  void _internal_set_color(::MyPerson::Color value);
  public:

  // @@protoc_insertion_point(class_scope:MyPerson.Person)
 private:
  class _Internal;
...
inline int32_t Person::id() const {
  // @@protoc_insertion_point(field_get:MyPerson.Person.id)
  return _internal_id();
}
...
inline void Person::set_id(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:MyPerson.Person.id)
}
...
inline std::string* Person::add_name() {
  ...
  // @@protoc_insertion_point(field_add_mutable:MyPerson.Person.name)
  return _s;
}
...
inline const std::string& Person::name(int index) const {
  // @@protoc_insertion_point(field_get:MyPerson.Person.name)
  return _internal_name(index);
}
inline std::string* Person::mutable_name(int index) {
  // @@protoc_insertion_point(field_mutable:MyPerson.Person.name)
...
inline void Person::set_name(int index, const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:MyPerson.Person.name)
}
...
inline void Person::set_name(int index, const char* value) {
  ...
  _impl_.name_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:MyPerson.Person.name)
}
inline void Person::set_name(int index, const void* value, size_t size) {
  _impl_.name_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:MyPerson.Person.name)
}
...
inline void Person::add_name(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:MyPerson.Person.name)
}
...
inline void Person::add_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.name_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:MyPerson.Person.name)
}
inline void Person::add_name(const void* value, size_t size) {
  _impl_.name_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:MyPerson.Person.name)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Person::name() const {
  // @@protoc_insertion_point(field_list:MyPerson.Person.name)
  return _impl_.name_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
Person::mutable_name() {
  // @@protoc_insertion_point(field_mutable_list:MyPerson.Person.name)
  return &_impl_.name_;
}
...
inline const std::string& Person::sex() const {
  // @@protoc_insertion_point(field_get:MyPerson.Person.sex)
...
void Person::set_sex(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.sex_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:MyPerson.Person.sex)
}
inline std::string* Person::mutable_sex() {
  std::string* _s = _internal_mutable_sex();
  // @@protoc_insertion_point(field_mutable:MyPerson.Person.sex)
  return _s;
}
...
inline std::string* Person::release_sex() {
  // @@protoc_insertion_point(field_release:MyPerson.Person.sex)
...
inline void Person::set_allocated_sex(std::string* sex) {
  ...
  // @@protoc_insertion_point(field_set_allocated:MyPerson.Person.sex)
}
...
inline int32_t Person::age() const {
  // @@protoc_insertion_point(field_get:MyPerson.Person.age)
...
inline void Person::set_age(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:MyPerson.Person.age)
}
...
inline const ::MyAddress::Address& Person::_internal_addr() const {
  const ::MyAddress::Address* p = _impl_.addr_;
  return p != nullptr ? *p : reinterpret_cast<const ::MyAddress::Address&>(
      ::MyAddress::_Address_default_instance_);
}
inline const ::MyAddress::Address& Person::addr() const {
  // @@protoc_insertion_point(field_get:MyPerson.Person.addr)
...
inline void Person::unsafe_arena_set_allocated_addr(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:MyPerson.Person.addr)
}
inline ::MyAddress::Address* Person::release_addr() {
  
  ::MyAddress::Address* temp = _impl_.addr_;
...
inline ::MyAddress::Address* Person::unsafe_arena_release_addr() {
  // @@protoc_insertion_point(field_release:MyPerson.Person.addr)
  
  ::MyAddress::Address* temp = _impl_.addr_;
  _impl_.addr_ = nullptr;
  return temp;
}
inline ::MyAddress::Address* Person::_internal_mutable_addr() {
  
  if (_impl_.addr_ == nullptr) {
    auto* p = CreateMaybeMessage<::MyAddress::Address>(GetArenaForAllocation());
    _impl_.addr_ = p;
  }
  return _impl_.addr_;
}
inline ::MyAddress::Address* Person::mutable_addr() {
  ::MyAddress::Address* _msg = _internal_mutable_addr();
  // @@protoc_insertion_point(field_mutable:MyPerson.Person.addr)
  return _msg;
}
inline void Person::set_allocated_addr(::MyAddress::Address* addr) {
  ...
  _impl_.addr_ = addr;
  // @@protoc_insertion_point(field_set_allocated:MyPerson.Person.addr)
}
...
inline ::MyPerson::Color Person::_internal_color() const {
  return static_cast< ::MyPerson::Color >(_impl_.color_);
}
inline ::MyPerson::Color Person::color() const {
  // @@protoc_insertion_point(field_get:MyPerson.Person.color)
  return _internal_color();
}
inline void Person::_internal_set_color(::MyPerson::Color value) {
  
  _impl_.color_ = value;
}
inline void Person::set_color(::MyPerson::Color value) {
  _internal_set_color(value);
  // @@protoc_insertion_point(field_set:MyPerson.Person.color)
}
...
template <> struct is_proto_enum< ::MyPerson::Color> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::MyPerson::Color>() {
  return ::MyPerson::Color_descriptor();
}
