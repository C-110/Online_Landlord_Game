...
const uint32_t TableStruct_Person_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::MyPerson::Person, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::MyPerson::Person, _impl_.id_),
  PROTOBUF_FIELD_OFFSET(::MyPerson::Person, _impl_.name_),
  PROTOBUF_FIELD_OFFSET(::MyPerson::Person, _impl_.sex_),
  PROTOBUF_FIELD_OFFSET(::MyPerson::Person, _impl_.age_),
  PROTOBUF_FIELD_OFFSET(::MyPerson::Person, _impl_.addr_),
  PROTOBUF_FIELD_OFFSET(::MyPerson::Person, _impl_.color_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::MyPerson::Person)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::MyPerson::_Person_default_instance_._instance,
};

const char descriptor_table_protodef_Person_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014Person.proto\022\010MyPerson\032\rAddress.proto\""
  "~\n\006Person\022\n\n\002id\030\001 \001(\005\022\014\n\004name\030\002 \003(\014\022\013\n\003s"
  "ex\030\003 \001(\014\022\013\n\003age\030\004 \001(\005\022 \n\004addr\030\005 \001(\0132\022.My"
  "Address.Address\022\036\n\005color\030\006 \001(\0162\017.MyPerso"
  "n.Color*1\n\005Color\022\007\n\003Red\020\000\022\t\n\005Green\020\001\022\n\n\006"
  "Yellow\020\002\022\010\n\004Blue\020\003b\006proto3"
  ;
...
class Person::_Internal {
 public:
  static const ::MyAddress::Address& addr(const Person* msg);
};
...
Person::Person(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:MyPerson.Person)
}
Person::Person(const Person& from)
  ...
  if (from._internal_has_addr()) {
    _this->_impl_.addr_ = new ::MyAddress::Address(*from._impl_.addr_);
  }
  ::memcpy(&_impl_.id_, &from._impl_.id_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.color_) -
    reinterpret_cast<char*>(&_impl_.id_)) + sizeof(_impl_.color_));
  // @@protoc_insertion_point(copy_constructor:MyPerson.Person)
}
...
Person::~Person() {
  // @@protoc_insertion_point(destructor:MyPerson.Person)
...
void Person::Clear() {
// @@protoc_insertion_point(message_clear_start:MyPerson.Person)
    ...
    switch (tag >> 3) {
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          ...
          CHK_(ptr);
          _internal_set_color(static_cast<::MyPerson::Color>(val));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* Person::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:MyPerson.Person)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:MyPerson.Person)
  return target;
}

size_t Person::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:MyPerson.Person)
  size_t total_size = 0;
...
void Person::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:MyPerson.Person)
  ...
  if (from._internal_has_addr()) {
    _this->_internal_mutable_addr()->::MyAddress::Address::MergeFrom(
        from._internal_addr());
  }
...
// @@protoc_insertion_point(class_specific_copy_from_start:MyPerson.Person)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::MyPerson::Person*
Arena::CreateMaybeMessage< ::MyPerson::Person >(Arena* arena) {
  return Arena::CreateMessageInternal< ::MyPerson::Person >(arena);
}
