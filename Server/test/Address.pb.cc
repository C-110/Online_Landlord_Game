...
const uint32_t TableStruct_Address_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::MyAddress::Address, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::MyAddress::Address, _impl_.num_),
  PROTOBUF_FIELD_OFFSET(::MyAddress::Address, _impl_.addr_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::MyAddress::Address)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::MyAddress::_Address_default_instance_._instance,
};

const char descriptor_table_protodef_Address_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rAddress.proto\022\tMyAddress\"$\n\007Address\022\013\n"
...
const ::_pbi::DescriptorTable descriptor_table_Address_2eproto = {
    false, false, 72, descriptor_table_protodef_Address_2eproto,
    "Address.proto",
...
Address::Address(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:MyAddress.Address)
}
Address::Address(const Address& from)
  ...
  // @@protoc_insertion_point(copy_constructor:MyAddress.Address)
}
...
Address::~Address() {
  // @@protoc_insertion_point(destructor:MyAddress.Address)
...
void Address::Clear() {
// @@protoc_insertion_point(message_clear_start:MyAddress.Address)
...
uint8_t* Address::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:MyAddress.Address)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:MyAddress.Address)
  return target;
}

size_t Address::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:MyAddress.Address)
  size_t total_size = 0;
...
void Address::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:MyAddress.Address)
...
// @@protoc_insertion_point(class_specific_copy_from_start:MyAddress.Address)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::MyAddress::Address*
Arena::CreateMaybeMessage< ::MyAddress::Address >(Arena* arena) {
  return Arena::CreateMessageInternal< ::MyAddress::Address >(arena);
}
